...
function pages(): array {
  $p = [
    ...
    'faq.html' => [
      ...
      'desc'  => 'Answers about Fudgio delivery in Lahore, Cash on Delivery, nut allergens, order tracking and confirming your order by SMS at checkout.',
      'index' => true,
      'priority' => '0.6',
    ],
    'contact.html' => [
...
function faq_schema(): array {
  $qa = [
    ...
    ['How do you confirm my order at checkout?',
     'After you fill in your delivery details we text a 5-digit code to your mobile number. Enter it on the next step and your order is placed. There is also a short code shown as an image, which keeps automated bulk orders off the shop.'],
